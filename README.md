...
{
Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "Mithun Kumar.G");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212224230160");
        HAL_Delay(500);
}
void SystemClock_Config(void)
{
...
<img width="1270" height="872" alt="Screenshot 2025-09-22 085115" src="https://github.com/user-attachments/assets/5be1c164-2489-4d4d-be90-598106e116d1" />

## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

<img width="703" height="571" alt="image" src="https://github.com/user-attachments/assets/dc37d6f3-79cc-480c-aa76-5e90a02b1fc3" />
